...
const TOKEN_PLANS = [
  ...
  // 2026.04.25 更新模型列表：新增 DeepSeek-V4-Pro/Flash、MiMo-V2.5 系列，共 14 模型
  // 文档：https://opencode.ai/docs/zh-cn/go/#usage-limits
  { platform:'OpenCode Go', name:'Go', currency:'$', monthly:10, quarterly:null, yearly:null, firstMonth:5,
    models:['GLM-5.1','GLM-5','Kimi-K2.6','Kimi-K2.5','MiMo-V2-Pro','MiMo-V2-Omni','MiMo-V2.5-Pro','MiMo-V2.5','Qwen3.6-Plus','MiniMax-M2.7','MiniMax-M2.5','Qwen3.5-Plus','DeepSeek-V4-Pro','DeepSeek-V4-Flash'],
    creditsBudget:'$12/5h $30/周 $60/月', benefits:['首月$5','14款开源模型','DeepSeek-V4新增'],
