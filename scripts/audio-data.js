...
const AUDIO_PLANS = [
  ...
  { platform:'Suno', name:'Pro', monthly:69, yearly:661, credits:'2500积分/月（约500首歌）', audioLen:'4分钟',
    features:['文生音乐','商用授权','优先队列','10个任务并发','v5.5模型'], note:'官方 $10/月；年付 $96/年（$8/月，省20%）·当前春季特惠首年再省20%（$6.40/月）·Pro支持v4/v4.5/v4.5+/v5/v5.5全系列模型', link:'https://suno.com' },
  ...
  { platform:'Udio', name:'Standard', monthly:69, yearly:662, credits:'2400积分/月', audioLen:'2分10秒',
    features:['更长音乐','商用授权','Voice Control','歌词编辑'], note:'官方 $10/月；年付 $96/年（$8/月）·2400 credits/月·无每日上限·支持Free Trial试用', link:'https://www.udio.com' },
  ...
  // 海螺AI（MiniMax Audio）— 2026.04.17 通过CDP已登录Edge核对订阅页
  // 当前订阅页展示 5 档：免费 / 标准版 / 创作版 / 专业版 / 大师版；年度价格分别折合 ¥32 / 98 / 188 / 588 每月
  // 模型权益页展示：Music-2.6/2.5+/2.5/2.0, Speech 2.8/2.6/2.5/02 (各含Turbo/HD)
