...
function getCommonModelPriority(model) {
  ...
  if (model === 'GPT-4.1') return [4, 0];
  if (model === 'GPT-Image-2') return [5, 0];
  if (model === 'o3') return [6, 0];
  if (model === 'o4-mini') return [7, 0];
  ...
  if (model === 'MiniMax-M2.5') return [13, 0];
  if (model.startsWith('GPT-')) return [14, 0];
  if (model.startsWith('o')) return [15, 0];
  if (model.startsWith('Kimi-')) return [8, 2];
  if (model.startsWith('DeepSeek')) return [9, 1];
  if (model.startsWith('Qwen')) return [11, 1];
  if (model.startsWith('MiniMax-')) return [13, 1];
  return [99, 0];
}
