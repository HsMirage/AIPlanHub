...
- **Video**（2026.09.03）（🔄新增 OpenArt 四档 Starter/Plus/Pro/Wonder：月付 $14/$34/$56/$240·年付折后 $13/$27/$44/$175 每席/月（10/20/22/27% off）·Monthly/Annually 双视图实测；另即梦 Seedance 2.5 720P 成片积分折扣活动期限修正：官方文案为 8月26日-9月7日（原记录至 9.8）·video+image 双文件同步；其余经核对无变化：即梦五视图全一致·可灵三视图全一致·RunningHub 连续包月/单月/单年+团队年付全一致·腾讯混元双文档一致·通义万相三档一致；海螺AI/pai.video 登录墙·Vidu CDN 拦截—双源无国内订阅价证据·本地保持不变）
- **Image**（2026.09.03）（🔄新增 OpenArt 四档（与 Video 同步·月付 $14/$34/$56/$240·年付折后 $13/$27/$44/$175 每席/月）；其余经核对无变化）
- **Audio**（2026.09.03）（经核对无变化）
