...
> Coding 数据更新于 2026.08.01（经核对无变化；Ollama Max 暂停新注册） · Token 数据更新于 2026.07.31（7个监控条目逐一访问，经核对无变化；腾讯4个旧HY模型已正式下线，Kimi-K2.5/MiniMax-M2.5仍保留即将下线标注；其余套餐价格、额度、模型无新增变化） · Video 数据更新于 2026.08.01（即梦季度首购价与Seedance 2.5权益更新；RunningHub团队优享/进阶永久月价下调；快手可灵、腾讯混元、通义万相无变化；Vidu/海螺AI/pai.video部分证据不足，已执行AnySearch） · Image 数据更新于 2026.08.01（即梦统一会员季度首购价与Seedance 2.5权益同步更新；其余平台按证据核对） · Audio 数据更新于 2026.08.01（经核对无变化；Suno/Udio/Ace Studio官方定价页证据完整；海螺AI订阅页重定向至创作首页且AnySearch无法确认） · 中转站 数据更新于 2026.07.05（经核对无变化） · 价格对比 新增于 2026.07.06
