...
>
- **Coding**（2026.09.03）（🔄Charm Hyper 模型目录 31→32 款新增 Kimi-K2-Thinking；🔄Ollama Team 档重定价 $25/席/月→$500/月（Early access·无限用户·$1,000 credits/月）；🔄稳明光语纪主模型 GLM-5.2→GLM-5.3；🔄AtomCode 三档支持模型新增 MiMo-V2.5/MiMo-V2.5-Pro；✂️评分卡片精简·删除 CommandCode/xKiro/国家超算互联网的通用兼容话术；其余经核对无变化）
