...
- **Video**（2026.09.13）（即梦团队会员大改版：原¥730/¥3,288团队档下架·改为超级团队会员¥6,319/席/月·12个月首年4.2折¥22,932/席；其余经核对无变化；海螺AI/pai.video 登录墙·Vidu 懒加载——双源佐证无变化）
- **Image**（2026.09.13）（即梦团队会员大改版：原¥730/¥3,288团队档下架·改为超级团队会员¥6,319/席/月·12个月首年4.2折¥22,932/席；其余经核对无变化）
- **Audio**（2026.09.13）（Suno/Udio/Ace Studio 经核对无变化；海螺AI 登录墙·双源无音频订阅证据）
...
| 平台 | 方案 | 月付 | 首月价 | 5h请求数 | 开通 |
|------|------|------|--------|----------|------|
| OpenCode Go | Go（Grok-4.6 / GLM-5.3-Flash / GLM-5.3 / GLM-5.2 / GPT-5.6-Luna / Kimi-K3 / DeepSeek-V4.1-Flash / Qwen3.8-Flash / Hy4-Preview / Hy3 / Omen-Alpha 等28款，⚠️国内 Muse Spark 1.2/1.3 不可调用·美元滚动额度 5h $12/周 $30/月 $60） | $10 | — | $12/5h $30/周 $60/月 | [Go \| OpenCode](https://opencode.ai/go?ref=V156X2ZH2S) |
