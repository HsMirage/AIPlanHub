...
> Coding 数据更新于 2026.08.14（CDP登录态复核讯飞星辰订阅页：高效版19款移除Kimi-K2.7-Code·新增DeepSeek-V4-Flash-0731；速通版新增DeepSeek-V4-Flash-0731(4→5款)·季付日常9折¥2697(原价¥2997)；xKiro评分降至4星（价格便宜但模型不算稳定·看个人选择·每天有生图额度）；Charm Hyper新增DeepSeek-V4-Flash-0731/Kimi-K3（16款模型）；其余平台经核对无变化；天翼云文档404（无Coding Plan恢复）·京东云CodingPlan停售确认；xKiro登录模型页未通过） · Token 数据更新于 2026.08.14（7个监控条目逐一访问·经核对无变化；腾讯·Token通用/Hy各4档价格额度与模型8款一致·Kimi-K2.5将于8.31下线；阿里个人版3档+用量包/团队版3档+共享用量包一致；MiMo 4档价格/Credits与MiMo Claw加购一致；OpenCode Go 18款模型一致；天翼云5档价格一致·818 Token Plan订购专区6档仍在（不入PLANS）；Alaya 3档一致；TaoToken Lite/Pro/加油包与7款模型一致） · Video 数据更新于 2026.08.14（8个平台逐一访问·经核对无变化；可灵月/季/年三视图一致·试用价5.99/11.99/17.99；RunningHub创作6档连续包月/单月/年付+团队4档月付年付全一致；腾讯混元文档价格一致；通义万相官方定价页三档一致；即梦横幅Seedance 2.5/图片5.0 Pro/3分钟视频观察项·价格需登录；海螺AI首页RSC价格一致·大师贝壳10000滞后值·H3模型上线横幅·尊享首购优惠首年14279观察项；Vidu CDN拦截（39/49资源失败）·pai.video登录墙，均执行AnySearch无法确认国内版价格） · Image 数据更新于 2026.08.14（5个平台逐一访问；Midjourney Zendesk API复核四档$10/$30/$60/$120及年付折扣无变化；Liblib AI六档月付/年付价格与积分无变化，Seedance系列&MiniMax H3狂欢季活动持续中（倒计时3天18时）；通义万相三档价格与灵感值无变化，修正标准会员并发3+3、高级会员视频时长10-30s；RunningHub创作会员六档连续包月/年付、团队会员四档月付/年付均无变化；堆友官方登录墙，AnySearch经阿里云市场确认专业版月卡¥59/季卡¥53/年卡¥399与本地一致，标准版/团队版无法核验） · Audio 数据更新于 2026.08.15（Suno/Udio/AceStudio官方定价页均成功·价格/积分/权益经核对无变化；Suno 9.3起月度下载限制Pro 20/Premier 60与本地一致；Ace Studio夏季特惠20% OFF持续；海螺AI订阅页Hermes两次重定向登录墙+CDP无登录态，AnySearch两轮搜索无法确认中国区音频订阅方案·本地数据保持不变） · 中转站 数据更新于 2026.07.05（经核对无变化） · 价格对比 新增于 2026.07.06
