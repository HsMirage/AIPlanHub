...
例如：Skill(skill: "web-access", args: "访问 https://www.liblib.art/viphome 并提取会员方案定价信息")
...
1. 调用 Skill(skill: "web-access", args: "访问 [平台URL] 并提取图片会员方案的所有定价信息，包括方案名称、月付/年付价格、积分额度、分辨率、功能列表等")
2. web-access 会在 Edge 浏览器中打开新标签页并提取信息
3. 如果页面需要登录才能看到定价，Edge 已有登录态会自动处理
4. 提取方案名称、价格、积分、分辨率、功能等关键信息
