...
const PLANS = [
  ...
  //   原首月优惠(¥39/¥79/¥159/¥559)已不再标注，"连续包月"价格仍为¥49/¥99/¥199/¥699
  { platform:'Kimi', name:'Andante', monthly:49, quarterly:null, yearly:468, firstMonth:null,
    models:['kimi-k2.6','Kimi-K2.5'], req5h:null, reqMonth:null, reqWeek:null, benefits:['专属编程额度','旗舰模型抢先体验'], note:'年付¥39/月·K2.6已上线·请求数未公开', link:'https://www.kimi.com/code/zh' },
  { platform:'Kimi', name:'Moderato', monthly:99, quarterly:null, yearly:948, firstMonth:null,
    models:['kimi-k2.6','Kimi-K2.5'], req5h:null, reqMonth:null, reqWeek:null, benefits:['每周更新额度','多设备共享'], note:'年付¥79/月·K2.6已上线·请求数未公开', link:'https://www.kimi.com/code/zh' },
  { platform:'Kimi', name:'Allegretto', monthly:199, quarterly:null, yearly:1908, firstMonth:null,
    models:['kimi-k2.6','Kimi-K2.5'], req5h:null, reqMonth:null, reqWeek:null, benefits:['充足每周额度','高并发上限'], note:'年付¥159/月·K2.6已上线·请求数未公开', link:'https://www.kimi.com/code/zh' },
  { platform:'Kimi', name:'Allegro', monthly:699, quarterly:null, yearly:6708, firstMonth:null,
    models:['kimi-k2.6','Kimi-K2.5'], req5h:null, reqMonth:null, reqWeek:null, benefits:['澎湃额度','高强度开发'], note:'年付¥559/月·K2.6已上线·请求数未公开', link:'https://www.kimi.com/code/zh' },
